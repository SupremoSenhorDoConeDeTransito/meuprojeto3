function getProjects() {
    const urlGitHub = "https://api.github.com/users/SupremoSenhorDoConeDeTransito/repos"; // Inserir o nome de usuário do seu github
  ...
  function showProjects(data) {
    ...
    data.forEach((repo) => {
      ...
      a.href = repo["https://github.com/SupremoSenhorDoConeDeTransito/meu-projeto"]; // Link para o repositório no GitHub
      a.target = "_blank";
